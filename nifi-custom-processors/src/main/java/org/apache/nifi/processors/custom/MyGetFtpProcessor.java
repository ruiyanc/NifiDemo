...
import org.apache.nifi.processors.custom.pojo.FTPTransfer;
import org.apache.nifi.processors.custom.pojo.FileTransfer;
...
public class MyGetFtpProcessor extends GetFileTransfer {
    ...
    protected void init(final ProcessorInitializationContext context) {
        ...
        properties.add(FTPTransfer.ENCODE);
        properties.add(FTPTransfer.TARPATH);
...
//        properties.add(FTPTransfer.UTF8_ENCODING);
    ...
    protected FileTransfer getFileTransfer(final ProcessContext context) {
        return new FTPTransfer(context);
    }
