...
public class MySocketClientTest extends AbstractProcessor {

    static Logger log = Logger.getLogger(String.valueOf((MySocketClientTest.class)));
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        String cacheFilePath = "/HTData/cache1" + File.separator + filename;
        log.info("cache1中的文件路径：" + cacheFilePath);
